...
function iconWrapper(path: React.ReactNode, props: IconProps) {
  const { className = 'h-5 w-5', size } = props;
  return (
    <svg
      className={className}
...
export function AdviserIcon(props: IconProps = {}) {
  return iconWrapper(
...
export function AllUsersIcon(props: IconProps = {}) {
  return iconWrapper(
...
export function ThesisIcon(props: IconProps = {}) {
  return iconWrapper(
