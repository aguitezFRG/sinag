      ...
      <div className="flex items-center gap-3">
        <div className="relative">
          <select
            ...
            className="appearance-none w-full px-4 py-2.5 pr-10 border-2 border-gray-200 rounded-xl bg-white text-sm text-gray-700 focus:outline-none focus:border-[#0C0B5D] focus:ring-2 focus:ring-[#0C0B5D] hover:border-gray-300 transition-all cursor-pointer"
          >
